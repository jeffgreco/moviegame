...
const DAILY_PUZZLES = [
  {
    ...
    movieIds: [
      597, 238, 13, 98,
      274, 424, 1366, 510,
      1422, 6977, 194662, 76203,
      376867, 74643, 399055, 776503,
      792, 380, 581, 12162,
    ],
  },
  {
  ...
  },
  {
    ...
    movieIds: [
      578, 238, 329, 85, 601, 424,
      103, 28, 769, 240, 857, 87,
      89, 524, 840, 1422, 879, 640,
      873, 242, 6114, 180, 74, 11324, 106646,
      227, 1598, 594, 217, 57212, 333339,
      839, 232, 11352, 7095,
    ],
  },
  {
    ...
    movieIds: [
      8587, 109445, 12, 862, 10020, 812,
      10144, 585, 14160, 10681, 38757, 354912,
      10674, 11970, 2062, 150540, 269149, 568124,
      37135, 10530, 177572, 82690,
      11544, 11688,
      10112, 11886,
    ],
  },
  {
    ...
    description: "",
    movieIds: [
      74, 602, 329865, 2675, 75, 59678, 8337, 755898,
      840, 7191, 5491, 137113, 44943, 9397, 9348, 8974,
    ],
  },
  {
    id: "m4k7r",
    ...
    description: "",
    movieIds: [
      274, 1949, 539, 1359, 504, 807, 320,
      10279, 241, 71859, 12149, 768, 9740,
    ],
  },
